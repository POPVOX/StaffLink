...
$iconClasses = Flux::classes('text-zinc-400 dark:text-white/80 group-hover:text-zinc-800 group-hover:dark:text-white')
...
<button type="button" {{ $attributes->class($classes) }} data-flux-profile>
    <div class="shrink-0 size-8 bg-zinc-200 rounded overflow-hidden dark:bg-zinc-700">
